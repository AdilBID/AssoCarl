...
const Soutenir: React.FC = () => {
  const sections: Section[] = [
    {
      title: "ACCOMPAGNEMENT DES VICTIMES",
      link: "",
      subtitles: "",
      content:
          "Nous priorisons les demandes d'aide effectuées directement par les enfants (jusque 18 ans), mais selon " +
          "le degré de gravité et nos possibilités, nous venons également en aide au parent " +
  ...
  return (
      <div className="support">
        <div className="support-intro">
          <h1>NOS ACTIONS</h1>
          <p>
            Notre équipe de bénévoles met tout en oeuvre afin de répondre à l'augmentation
            constante des demandes d'aide. Aussi, avons-nous mis en place différents pôles en
            plus d'antennes dans chaque région, de manière à pouvoir agir efficacement dans le
            temps.
          </p>
        </div>
